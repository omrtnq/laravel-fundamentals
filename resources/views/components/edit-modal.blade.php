<div x-show='editModalOpen' class="relative z-10" role="dialog" aria-modal="true">
  <!--
      ...
      <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <form>
                  ...
                  <div class="grid grid-cols-12 gap-4">
                    <div class="form-group mb-6 col-span-3">
                      ...
                      <input type="number" class="form-control
                        ...
                        ease-in-out
                        mt-1
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="age"id="age"
                        value="{{ $student->age }}">
                    </div>
                    {{-- Gender --}}
                  ...
                  <div class="form-group mb-6">
                    ...
                    <input type="email" class="form-control block
                      ...
                      ease-in-out
                      mt-1
                      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="email" id="email"
                      value="{{ $student->email }}">
                  </div>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
          <form action="/student/{{ $student->id }}" method="post">
            @method('delete')
            @csrf
            <button type="submit" class="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">Update</button>
          </form>
