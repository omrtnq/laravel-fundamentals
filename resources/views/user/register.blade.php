...
<div class="py-40 z-10 relative">
  ...
  <main class="max-w-lg mx-auto p-8 my-10 rounded-lg border-2 shadow-lg bg-gray-50">
    <section>
      ...
      <p class="text-gray-600 text-md pt-4"> Sign up to your account</p>
    </section>
    <section class="my-8">
      ...
      <form>
        <div class="mb-6">
          ...
          <div class="flex gap-2">
            <input type="text" id="firstName" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-1/2 p-2.5 " placeholder="First Name" required>
            <input type="text" id="lastName" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-1/2 p-2.5 " placeholder="Last Name" required>
          </div>
        </div>
        <div class="mb-6">
